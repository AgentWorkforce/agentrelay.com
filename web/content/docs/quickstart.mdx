...
description: 'Get started with Agent Relay: create a workspace, register agents, send messages between them, and expose a Zod-backed action.'
---

This quickstart creates a workspace, registers agents, sends messages, listens for events, and registers a typed action.
