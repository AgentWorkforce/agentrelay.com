...
`--backend internal` runs agents on this machine; `--backend relay` places them on fleet nodes through the hosted engine. See [Where it runs](/docs/factory/where-it-runs).
