...
Progress reporting to the Agent Relay dashboard is on by default — see [Watching it work](/docs/factory/introduction#watching-it-work). Turn it off only when the dashboard isn't part of your deployment:
