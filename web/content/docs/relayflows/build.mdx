...
<BannerLink href="https://github.com/AgentWorkforce/skills/blob/main/skills/writing-relayflows/SKILL.md" icon="bot">
  Give your coding agent the writing-relayflows skill instead of pasting this page into its context: `npx skills add https://github.com/agentworkforce/skills --skill writing-relayflows`
</BannerLink>
