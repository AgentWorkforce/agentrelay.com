...
- `--source` — restrict to one source. Valid values are `claude`, `codex`, `cursor`, `relay`, `trajectory`, and `opencode`. See [Sources](/docs/loop/sources).
