...
<CardGroup cols={3}>
  ...
  <Card title="Burn">
    Token spend by model, tool, project, and engineer. Find the waste, forecast the cost, and kill runaway loops before they bill you twice.
  </Card>
  <Card title="Insights">
...
When you want durable backup, cross-device access, a web UI, and team recall, you opt into [Relayloop Cloud](/docs/loop/cloud). The local CLI does not change and keeps working offline either way.
...
<CardGroup cols={3}>
  ...
  <Card title="Cloud" href="/docs/loop/cloud">
    Opt into durable backup, cross-device sync, and team recall.
  </Card>
</CardGroup>
