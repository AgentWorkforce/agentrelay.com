...
description: "Claude workflows are great, but they do not let you mix agent runtimes. Here is a short playbook for Claude's recommended multi-agent strategies using Agent Flows, with compact code examples."
date: '2026-06-03'
...
We've been using [Flows](https://github.com/agentworkforce/relayflows) for a few months and they've proven to be a power tool we keep coming back to. Use Claude where communication and judgment matter, Codex where deep implementation matters, OpenCode where provider flexibility matters, Gemini where broad context helps, and deterministic gates where trust matters.
