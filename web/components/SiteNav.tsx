...
export function LogoIcon() {
  return (
    <svg className={s.logoIcon} viewBox="0 0 112 91" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
