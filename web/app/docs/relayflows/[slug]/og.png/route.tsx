...
import { relayflowsSection } from '../../../../../lib/product-docs-nav';
...
export function generateStaticParams() {
  return getProductDocSlugs(relayflowsSection).map((slug) => ({ slug }));
}

export async function GET(_request: Request, { params }: RouteContext) {
  const { slug } = await params;
  const doc = getProductDoc(relayflowsSection.id, slug);
  ...
  return new ImageResponse(
    <DefaultVariant
      ...
      eyebrow={relayflowsSection.label}
